...
export const BookCard = React.memo<BookCardProps>(({ book, onOpen, onDelete }) => (
    <div className="group relative bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-xl hover:border-brand-200 transition-all">
        ...
        <button
            ...
            className="absolute top-3 right-3 p-2 bg-white/90 backdrop-blur rounded-full text-slate-400 hover:text-red-500 hover:bg-red-50 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500"
